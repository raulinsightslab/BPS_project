...
const List<VideoItem> kVideos = [
  VideoItem(
    num: '01',
    title: 'Sinergi Data BPS dan Google Scholar: Strategi Peneliti Cerdas',
    description:
  ...
  VideoItem(
    ...
    youtubeId: 'PpYQjQ2jjwo',
  ),
  VideoItem(
    num: '03',
    title: 'Prospek Deep Learning Model untuk Analisis Citra Medis',
    description:
...
class DashboardScreen extends StatelessWidget {
  ...
  void _openPlayer(BuildContext context, VideoItem video, int index) {
    Navigator.push(
      context,
      PageRouteBuilder(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          const Text(
            'Tingkatkan pengetahuan statistikmu bersama BPS',
            style: TextStyle(
              fontSize: 13,
